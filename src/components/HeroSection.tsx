    ...
    return (
        <>
            <section className="relative min-h-[90vh] flex flex-col justify-center px-6 md:px-20 max-w-7xl mx-auto z-10 text-center items-center">
                <div className="absolute top-1/4 w-72 h-72 rounded-full opacity-10 blur-[120px] transition-all duration-1000 animate-pulse pointer-events-none"
                    style={{
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center pt-8">
                            <button onClick={() => {
                                ...
                                Configure Build
                                <ArrowRight size={13} className="group-hover:traslate-x-1 transition-transform" />
                            </button>
                            <button onClick={() => {
                    ...
                    <div
                        ...
                        className="absolute botoom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 cursor-pointer opacity-50 hover:opacity-100 transition-opacity">
                        <span className="font-mono text-[9px] tracking-widest uppercase text-[#bac9cc] ">
                            Scroll to Configure
                        </span>
                        <ChevronDown size={14} className="animate-bounce" style={{
                            color: primaryColor
                        }}/>
                    </div>
                </div>
