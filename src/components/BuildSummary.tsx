        ...
        <div className="lg:col-span-5 lg:sticky lg:top-28 space-y-6">
            <div className="glass-panel rounded-3xl p-8 border border-white/5 relative overflow-hidden shadow-2xl">
                ...
                <button
                    ...
                    className="w-full py-4 font-mono text-[10px] uppercase tracking-widest text-black font-bold transition-all duration-300 hover:bg-white active:scale-95 cursor-pointer"
                    style={{
